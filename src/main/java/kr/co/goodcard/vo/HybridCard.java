...
@Document(collection="hybridCard")
public class HybridCard {
	...
	public HybridCard(String id, String brand, String cardName, String annotation, String imagePath,
			List<AnnualFee> annualFee, List<LimitBenefit> limitBenefit, List<SpecialService> specialServices,
			List<Benefits> benefits, int viewCount) {
		this.id = id;
		this.brand = brand;
	...
	public String toString() {
		return "Card [id=" + id + ", brand=" + brand + ", cardName=" + cardName + ", annotation=" + annotation
				+ ", imagePath=" + imagePath + ", annualFee=" + annualFee + ", limitBenefit=" + limitBenefit
				+ ", specialServices=" + specialServices + ", benefits=" + benefits + ", viewCount=" + viewCount + "]";
	}
