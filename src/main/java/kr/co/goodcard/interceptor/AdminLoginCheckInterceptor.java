...
import kr.co.goodcard.annotation.AdminLoginCheck;
...
public class AdminLoginCheckInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
		...
		try {
			...
			AdminLoginCheck sessionCheck =
					((HandlerMethod) handler).getMethodAnnotation(AdminLoginCheck.class);
			...
			if(loginUser != null && loginUser.getType().equals("S")){
				return true;
			}
