...
<body>
	...
	<div id="subMenu" class="container" style="font-size: 11pt">
		...
		<a href="${context}">홈</a><i class="fa fa-chevron-right" aria-hidden="true"></i><a>회원정보</a><i class="fa fa-chevron-right" aria-hidden="true"></i><a href="${context}/member/login.do">로그인</a>
	</div>
